...
if (HandRanks[0] > HandRanks[1]) printf("Black wins.");
else if (HandRanks[0] < HandRanks[1])printf("White wins.");
else
{
if (HandValues[0] > HandValues[1])printf("Black wins.");
else if (HandValues[0] < HandValues[1])printf("White wins.");
else printf("Tie.");
}
